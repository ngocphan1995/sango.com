...
if (! nv_function_exists('nv_global_bxproduct_center')) {
    ...
    function nv_global_bxproduct_center($block_config)
    {
        ...
        $db->sqlreset()
            ->select('t1.id, t1.listcatid, t1.' . NV_LANG_DATA . '_title AS title, t1.' . NV_LANG_DATA . '_alias AS alias,t1.' . NV_LANG_DATA . '_hometext, t1.homeimgfile, t1.homeimgthumb , t1.homeimgalt, t1.showprice, t1.discount_id')
        ...
        foreach ($list as $row) {
            ...
            $xtpl->assign('SRC_IMG', $src_img);
             $xtpl->assign('hometext', $row[NV_LANG_DATA . '_hometext']);
