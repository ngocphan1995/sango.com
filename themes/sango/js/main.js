...
$(function() {
	...
	//Search form
	$(".menu_search button").on("click", function() {
		if ("n" == $(this).attr("data-click")) return !1;
		$(this).attr("data-click", "n");
		var a = $(".menu_search input"),
			c = a.attr("maxlength"),
			b = strip_tags(a.val()),
	...
	$(".menu_search input").on("keypress", function(a) {
		13 != a.which || a.shiftKey || (a.preventDefault(), $(".menu_search button").trigger("click"))
	});
