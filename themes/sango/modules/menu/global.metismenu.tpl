    ...
    <aside class="sidebar">
        <nav class="sidebar-nav">
            <ul id="menu_{MENUID}">
                <!-- BEGIN: loopcat1 -->
                <li>
                    <i class="uk-icon-chevron-right" style="font-family: FontAwesome;
                       display: inline-block;
                       font-weight: 400;
                       font-style: normal;
                       line-height: 1;
                       -webkit-font-smoothing: antialiased;"></i><a title="{CAT1.note}" href="{CAT1.link}"{CAT1.target}>{CAT1.title_trim}</a>
                    <!-- BEGIN: expand -->
